...
from database.service.character_server_service import get_all_characters_from_discord_server_by_id
...
async def rank(interaction: discord.Interaction):
    ...
    all_characters_in_discord_server_ids = await get_all_characters_from_discord_server_by_id(discord_server_instance.id)
    all_characters = await get_characters_by_ids([character.character_id for character in all_characters_in_discord_server_ids])
