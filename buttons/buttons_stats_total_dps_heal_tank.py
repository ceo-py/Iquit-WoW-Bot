...
class ButtonsCharacterStatistics(discord.ui.View):
    ...
    @discord.ui.button(label=" ", style=discord.ButtonStyle.gray, custom_id="1", emoji="<:Totalrole:1058488589459136512>")
    ...
    @discord.ui.button(label=" ", style=discord.ButtonStyle.gray, custom_id="2", emoji="<:DPSrole:1058479594438668468>")
    ...
    @discord.ui.button(label=" ", style=discord.ButtonStyle.gray, custom_id="3", emoji="<:Healerrole:1058479567616090222>")
    ...
    @discord.ui.button(label=" ", style=discord.ButtonStyle.gray, custom_id="4", emoji="<:Tankrole:1058479529158529124>")
