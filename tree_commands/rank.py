...
class TreeCommands:
    ...
    @staticmethod
    def custom_channel_options():
        return Literal["Add", "Remove"]
    ...
    @staticmethod
    def remove_channels(all_channels: dict, channels_to_remove: dict) -> dict:
        common_keys = set(all_channels.keys()) - set(channels_to_remove.values())
        return {key: all_channels[key] for key in common_keys}
