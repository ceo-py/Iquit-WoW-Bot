...
class AddCharacterModal(discord.ui.Modal, title="Character Information"):
    ...
    nickname = discord.ui.TextInput(label='Your Nickname', placeholder="Nickname", max_length=12)
    character_class = discord.ui.TextInput(label='Your Character Class', placeholder="Your character class", max_length=12)
