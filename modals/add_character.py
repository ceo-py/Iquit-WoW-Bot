...
class AddCharacterModal(discord.ui.Modal, title="Character Information"):
    ...
    character_name = discord.ui.TextInput(
        label="Character Name", placeholder="In game character name", max_length=12
    )
    nickname = discord.ui.TextInput(
        label="Nickname", placeholder="Nickname", max_length=12
    )
    character_class = discord.ui.TextInput(
        label="Character Class", placeholder="Your character class", max_length=12
    )
